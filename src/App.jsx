      ...
      return (
        <div className="d-flex flex-column justify-content-center align-items-center vh-100 text-center p-4">
          ...
          <p className="text-muted">
            We have detected an issue. Please reload to fix it.
          </p>
          <button
...
const lawAliases = {
  ...
  "Constitution of Bangladesh (সংবিধান)": [
    "Constitution",
    "Konstitution",
    "Art.",
    "Article",
  ...
  "Code of Civil Procedure (CPC/দেওয়ানী)": [
    "CPC",
  ...
  "Code of Criminal Procedure (CrPC/ফৌজদারী)": [
    "CrPC",
  ...
  "Specific Relief Act (সুনির্দিষ্ট প্রতিকার)": [
    "Specific Relief",
    "SR Act",
    "S.R. Act",
    "Section 9",
  ...
  "General Clauses Act (জেনারেল ক্লজেস)": [
    "General Clauses",
    "Section 6",
    "Interpretation",
    "জেনারেল ক্লজেস",
  ...
  "Nari O Shishu Nirjatan Daman Ain (নারী ও শিশু)": [
    "Nari O Shishu",
    "Women and Children",
    "Nari-O-Shishu",
    "Trafficking",
  ...
  "Dowry Prohibition Act (যৌতুক নিরোধ)": [
    "Dowry",
    "Joutuk",
    "Demand of dowry",
    "যৌতুক",
  ],
  "Human Trafficking Deterrence Act (মানব পাচার)": [
    "Human Trafficking",
    "Trafficking",
    "Paachar",
    "মানব পাচার",
  ],
  "Pornography Control Act (পর্নোগ্রাফি নিয়ন্ত্রণ)": [
    "Pornography",
    "Porno",
    "পর্নোগ্রাফি",
  ],
  "Special Powers Act (বিশেষ ক্ষমতা)": [
    "Special Powers",
    "SPA",
    "Special Power",
    "Detention",
  ...
  "Anti-Terrorism Act (সন্ত্রাস বিরোধী)": [
    "Anti-Terrorism",
    "Terrorism",
    "Militant",
    "সন্ত্রাস",
  ...
  "Narcotics Control Act (মাদক দ্রব্য নিয়ন্ত্রণ)": [
    "Narcotics",
    "Madok",
    "Drug",
    "Table",
  ...
  "Ain Srinkhola Bighnokari (দ্রুত বিচার)": [
    "Druto Bichar",
    "Speedy Trial",
    "Disrupting Law and Order",
    "দ্রুত বিচার",
  ],
  "Digital Security & ICT Act (ডিজিটাল/সাইবার)": [
    "Digital Security",
    "Cyber",
    "ICT Act",
  ...
  "Mobile Court Act (মোবাইল কোর্ট)": [
    "Mobile Court",
    "Executive Magistrate",
    "মোবাইল কোর্ট",
  ],
  "Corruption & ACC Act (দুদক/দুর্নীতি)": [
    "Anti-Corruption",
    "ACC",
    "Dudok",
    "Graft",
  ...
  "Money Laundering Prevention Act (মানি লন্ডারিং)": [
    "Money Laundering",
    "Laundering",
    "মানি লন্ডারিং",
  ],
  ...
  "Artha Rin Adalat Ain (অর্থ ঋণ আদালত)": [
    "Artha Rin",
    "Money Loan",
    "Adalat",
    "Loan recovery",
  ...
  "Negotiable Instruments Act (NI Act/চেক ডিজঅনার)": [
  ...
  "Transfer of Property Act (সম্পত্তি হস্তান্তর)": [
  ...
  "Registration Act (রেজিস্ট্রেশন)": [
    "Registration",
    "Section 17",
    "Registered deed",
    "রেজিস্ট্রেশন",
  ],
  "Contract Act (চুক্তি আইন)": [
    "Contract Act",
    "Agreement",
    "Breach of contract",
  ...
  "Bankruptcy Act (দেউলিয়া আইন)": [
    "Bankruptcy",
    "Insolvency",
    "Receiver",
    "দেউলিয়া",
  ],
  "VAT & Customs (ভ্যাট ও কাস্টমস)": [
    "Value Added Tax",
    "VAT",
    "Musok",
    "Customs",
  ...
  // --- Land & Property ---
  "State Acquisition & Tenancy Act (প্রজাস্বত্ব)": [
    "State Acquisition",
    "SAT Act",
    "Tenancy",
    "Pre-emption",
  ...
  "Vested Property Return Act (অর্পিত সম্পত্তি)": [
    "Vested Property",
    "Enemy Property",
    "VP",
    "Return of property",
  ...
  "Non-Agricultural Tenancy Act (অ-কৃষি প্রজাস্বত্ব)": [
    "Non-Agricultural",
    "Non-agri",
    "Chandina",
    "অ-কৃষি",
  ],
  "Land Survey Tribunal (ভূমি জরিপ)": [
    "Land Survey",
    "L.S.T",
    "Tribunal",
    "Survey",
  ...
  // --- Family & Personal ---
  "Muslim Family Laws (মুসলিম পারিবারিক আইন)": [
    "Muslim Family",
    "MFLO",
    "Denmohar",
    "Dower",
  ...
  "Family Courts Ordinance (পারিবারিক আদালত)": [
    "Family Courts",
    "Family Court",
    "Restitution of conjugal rights",
    "পারিবারিক",
  ],
  "Guardians and Wards Act (অভিভাবক ও প্রতিপাল্য)": [
    "Guardians and Wards",
    "Guardian",
    "Custody",
    "Welfare of minor",
  ...
  "Administrative Tribunals Act (প্রশাসনিক ট্রাইব্যুনাল)": [
  ...
  "Road Transport & Motor Vehicles (সড়ক পরিবহন)": [
    "Road Transport",
    "Motor Vehicles",
    "Accident",
    "Driving License",
  ...
  "Environment Conservation Act (পরিবেশ সংরক্ষণ)": [
    "Environment",
    "Pollution",
    "Brick Kiln",
    "DoE",
  ...
  "Consumer Rights Protection Act (ভোক্তা অধিকার)": [
    "Consumer Rights",
    "Consumer",
    "DNCRP",
    "ভোক্তা অধিকার",
  ],
  "Food Safety Act (নিরাপদ খাদ্য)": [
    "Food Safety",
    "Adulteration",
    "Pure Food",
    "নিরাপদ খাদ্য",
  ],
  "Right to Information Act (তথ্য অধিকার)": [
...
function AppContent() {
  ...
  // ✅ FIX: useRef instead of state (prevents re-binding scroll listener on every scroll)
  ...
  useEffect(() => {
    // ✅ Define callback FIRST (prevents race condition if script loads fast)
    ...
    // Add Google Translate Script once
    ...
    // Inject CSS once
    const styleId = "google-translate-kill-style";
    if (!document.getElementById(styleId)) {
      ...
      style.innerHTML = `
        ...
        /* Hide mobile translate bar */
        .VIpgJd-ZVi9od-ORHb-OEVmcd { display: none !important; }
        #goog-gt-tt { display: none !important; visibility: hidden !important; }

        /* Professional Bangla font */
        @import url('https://fonts.googleapis.com/css2?family=Hind+Siliguri:wght@400;500;600&family=Noto+Sans+Bengali:wght@400;500;600&display=swap');
        ...
        /* Prevent weird Google <font> link styles */
  ...
  const toggleLanguage = () => {
    ...
    if (select) {
      ...
      openNotice({
        ...
        message: "Translation engine is getting ready. Please try again in 5 seconds.",
        primaryText: "OK",
  ...
  // beforeinstallprompt listener + fetch notifications
  useEffect(() => {
    const onBIP = (e) => {
      e.preventDefault();
      setDeferredPrompt(e);
  ...
  // viewport, theme-color, and navbar hide-on-scroll
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const onCopy = (e) => {
      ...
      openNotice({
        type: "warning",
        title: "Copy Disabled",
        message: "For content protection, copying is disabled. You can use the Print button.",
        primaryText: "OK",
        onPrimary: closeNotice,
      });
    };
    ...
    const onContextMenu = (e) => {
      ...
      openNotice({
        ...
        message: "Right-click is disabled to protect content.",
        primaryText: "OK",
        onPrimary: closeNotice,
      });
    };
  ...
  useEffect(() => {
    ...
    const { data: authListener } = supabase.auth.onAuthStateChange(async (event, sessionNow) => {
      if (!isMounted) return;

      setSession(sessionNow);
      setIsAdmin(sessionNow?.user?.email === ADMIN_EMAIL);
      setLoading(false);

      if (event === "PASSWORD_RECOVERY") setModalMode("resetPassword");

      if (sessionNow) {
        Promise.resolve().then(() => checkSubscription(sessionNow.user)).catch(() => {});

        if (event === "SIGNED_IN" || event === "TOKEN_REFRESHED") {
          Promise.resolve().then(() => updateSessionInDB(sessionNow)).catch(() => {});
          if (sessionInterval) clearInterval(sessionInterval);
          sessionInterval = startSessionMonitor(sessionNow);
        }
      } else {
        setSubStatus(false);
        setProfileData(null);
    ...
    const fetchSuggestions = async () => {
      ...
      if (!error && data) {
        ...
        data.forEach((item) => {
          ...
          const match = item.headnote.match(
            new RegExp(`\\b${trimmedTerm}[\\w]*(\\s+[\\w]+){0,3}`, "i")
          );
      ...
      try {
        ...
        if (!memberRow) {
          await forceSignOut({
            ...
            message: "Your account is no longer registered.",
          });
          return;
        }
        ...
        if (!resById?.error && resById?.data) {
          if (
            resById.data.current_session_id &&
            resById.data.current_session_id !== currentSession.access_token
          ) {
            await supabase.auth.signOut();
            hardClearAuthStorage();
            setSession(null);
        ...
        if (user.email) {
          ...
          if (!resByEmail?.error && resByEmail?.data) {
            if (
              resByEmail.data.current_session_id &&
              resByEmail.data.current_session_id !== currentSession.access_token
            ) {
              await supabase.auth.signOut();
              hardClearAuthStorage();
              setSession(null);
      ...
      if (type === "advanced") {
        ...
        if (!journal || !vol || !div || !pg) {
          openNotice({
            ...
            message: "Please fill all citation fields.",
            primaryText: "OK",
            onPrimary: closeNotice,
          });
          setLoading(false);
        ...
        if (isExactMatch) {
          ...
          if (words.length > 0) {
            textCondition = words
              .map((w) => `headnote.ilike.%${w}%,title.ilike.%${w}%`)
              .join(",");
          }
  ...
  const loadJudgment = async (item) => {
    ...
    try {
      ...
      setJudgmentText("Error: " + e.message);
      setParallelCitations([]);
      openNotice({
        type: "error",
        title: "Load Failed",
  ...
  const toggleBookmark = async (item) => {
    ...
    if (existingBookmark && existingBookmark.length > 0) {
      const { error } = await supabase.from("bookmarks").delete().eq("id", existingBookmark[0].id);
      if (error)
        openNotice({ type: "warning", title: "Error", message: "Could not remove bookmark.", primaryText: "OK", onPrimary: closeNotice });
      else
        openNotice({ type: "info", title: "Removed", message: "Bookmark removed.", primaryText: "OK", onPrimary: closeNotice });
    } else {
      ...
      if (error)
        openNotice({ type: "warning", title: "Error", message: "Could not save bookmark.", primaryText: "OK", onPrimary: closeNotice });
      else
        openNotice({ type: "success", title: "Saved", message: "Bookmark added.", primaryText: "OK", onPrimary: closeNotice });
    }
  };
    ...
    if (data) {
      setResults(
        data.map((b) => ({
          id: b.id,
          title: b.case_title,
          citation: b.case_citation,
          case_anchor: b.case_anchor,
          github_filename: b.github_filename,
          is_premium: true,
          headnote: "Saved Bookmark",
        }))
      );
      setView("results");
  ...
  return (
    <div>
          ...
          {globalNotifications.slice(0, 1).map((note) => (
            ...
            >
              ...
              <div style={{ padding: "0 25px 25px 25px" }}>
                <button className="btn btn-dark w-100 py-2 rounded-pill fw-bold" onClick={() => dismissNotification(note.id)}>
                  Got it
                </button>
              </div>
            </div>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto align-items-center">
              <li className="nav-item">
                <a className="nav-link nav-link-close" href="#" onClick={() => { setView("home"); setResults([]); }}>
                  Home
                </a>
              </li>

              <li className="nav-item">
                <a className="nav-link nav-link-close" href="#" onClick={fetchBookmarks}>
                  Bookmarks
                </a>
              </li>

              <li className="nav-item">
                <a className="nav-link nav-link-close" href="#packages">
                  Pricing
                </a>
              </li>
          ...
          <div className="search-container">
            <div className="search-container-box" style={{ position: "relative" }}>
              <div className="law-select-wrapper">
                ...
                <datalist id="lawList">
                  {Object.keys(lawAliases).map((law) => (
              ...
              <button className="btn btn-link text-secondary" onClick={() => setShowAdvSearch(!showAdvSearch)}>
                <i className="fas fa-sliders-h"></i>
              </button>

              <button className="btn-search-hero" onClick={() => handleSearch(1)}>
              ...
              <div className="adv-search-panel" style={{ display: "block" }}>
                ...
                <div className="row g-2">
                  ...
                  <div className="col-6 col-md-2">
                    <input type="text" className="form-control form-control-sm" placeholder="Vol" onChange={(e) => setAdvFields({ ...advFields, vol: e.target.value })} />
                  </div>
                  ...
                  <div className="col-6 col-md-2">
                    <input type="text" className="form-control form-control-sm" placeholder="Page" onChange={(e) => setAdvFields({ ...advFields, page: e.target.value })} />
                  </div>

                  <div className="col-12 col-md-2">
                    <button className="btn btn-dark btn-sm w-100" onClick={() => handleSearch(1, "advanced")}>
                      Go
                    </button>
                  </div>
                </div>
            ...
            {results.map((item) => (
              <div key={item.id} className="result-item" onClick={() => loadJudgment(item)}>
                ...
                <div className="mb-2">
                  {session && subStatus ? (
                    <>
                      <span className="badge bg-light text-dark border">{item.citation}</span>
                      <span className="text-muted small ms-2">{item.division}</span>
                    </>
                  ) : (
        ...
        {view === "reader" && !loading && currentJudgment && (
          <div id="readerView" className={`bg-white p-4 p-md-5 rounded-3 shadow-sm border mb-5 ${isTranslated ? "translated-mode" : ""}`}>
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 border-bottom pb-3 gap-3">
              <button className="btn btn-outline-secondary btn-sm align-self-start align-self-md-center notranslate" onClick={handleBackToResults}>
              ...
              <div className="d-flex gap-2 flex-wrap justify-content-center">
                ...
                <button className="btn btn-sm btn-outline-warning text-dark rounded-pill px-3 notranslate" onClick={() => toggleBookmark(currentJudgment)}>
                  <i className="far fa-bookmark"></i> Save
                </button>

                <button className="btn btn-sm btn-outline-dark rounded-pill px-3 notranslate" onClick={() => window.print()}>
                  <i className="fas fa-print"></i> Print
                </button>
              </div>
            </div>

            <h3 className="fw-bold text-center text-primary mb-2 notranslate" style={{ fontFamily: "Playfair Display" }}>
              {currentJudgment.title}
            </h3>
            ...
            {parallelCitations.length > 0 && (
              <div className="text-center mb-4 notranslate">
                ...
                {parallelCitations.map((cite, index) => (
                  <span key={index} className="badge bg-light text-secondary border me-1">
                    {cite}
                  </span>
                ))}
              </div>
            ...
            <div
              ...
              style={{ whiteSpace: "pre-wrap", fontFamily: "Merriweather", textAlign: "justify", lineHeight: "1.8" }}
        ...
        {view === "home" && (
          <div id="featuresSection" className="py-5 notranslate" style={{ background: "#fff" }}>
            <div className="text-center mb-5">
              <h2 className="fw-bold text-dark" style={{ fontFamily: "Playfair Display" }}>
                Why Choose BDKanoon?
              </h2>
          ...
          <div className="row g-4 justify-content-center">
            <div className="col-md-3 col-sm-6">
              <div className="pricing-card">
                ...
                <a href="https://shop.bkash.com/ak-jurist-law-firm01911008518/pay/bdt199/4NosNL" target="_blank" rel="noreferrer" className="btn-plan">
                  Get Started
                </a>
              </div>
            </div>
            ...
            <div className="col-md-3 col-sm-6">
              <div className="pricing-card popular">
                ...
                <a href="https://shop.bkash.com/ak-jurist-law-firm01911008518/pay/bdt499/IxcDIa" target="_blank" rel="noreferrer" className="btn-plan">
                  Get Started
                </a>
              </div>
            </div>
            ...
            <div className="col-md-3 col-sm-6">
              <div className="pricing-card">
                ...
                <a href="https://shop.bkash.com/ak-jurist-law-firm01911008518/pay/bdt1200/O3FBxR" target="_blank" rel="noreferrer" className="btn-plan">
                  Get Started
                </a>
              </div>
            </div>
            ...
            <div className="modal-content border-0 shadow-lg" style={{ borderRadius: "15px" }}>
              <div className="modal-header bg-dark text-white border-0">
                <h5 className="modal-title fw-bold">
                  <i className="fas fa-tachometer-alt me-2"></i>Admin Notification Center
                </h5>
                    ...
                    <form onSubmit={sendAdminNotification}>
                      <div className="row">
                        ...
                        <div className="col-12 mb-3">
                          ...
                          <input type="datetime-local" className="form-control" value={adminExpiryInput} onChange={(e) => setAdminExpiryInput(e.target.value)} />
                        ...
                        <div className="col-12 mb-3">
                          ...
                          <textarea className="form-control" rows="3" placeholder="Write your message here..." value={adminMsgInput} onChange={(e) => setAdminMsgInput(e.target.value)} required style={{ resize: "none" }} />
                        </div>
                      </div>
                    ...
                    {globalNotifications.map((notif) => (
                      <div key={notif.id} className="list-group-item list-group-item-action d-flex justify-content-between align-items-center p-3 border-0 mb-2 shadow-sm rounded">
                        ...
                        <div className="d-flex flex-column gap-2">
                          <button className="btn btn-outline-dark btn-sm rounded-circle" onClick={() => handleEditClick(notif)} title="Edit">
                            <i className="fas fa-edit"></i>
                          </button>
                          <button className="btn btn-outline-danger btn-sm rounded-circle" onClick={() => deleteNotification(notif.id)} title="Delete">
            ...
            <div className="modal-content">
              ...
              <div className="modal-body p-4 pt-3">
                <ul className="nav nav-pills nav-fill mb-3" id="pills-tab" role="tablist">
                  <li className="nav-item" role="presentation">
                    <button className="nav-link active" id="pills-login-tab" data-bs-toggle="pill" data-bs-target="#pills-login" type="button">
                      Login
                    </button>
                  </li>
                  <li className="nav-item" role="presentation">
                    <button className="nav-link" id="pills-signup-tab" data-bs-toggle="pill" data-bs-target="#pills-signup" type="button">
                      Sign Up
                    </button>
                  </li>
                </ul>
                    ...
                    >
                      ...
                      <div className="text-end mb-3">
                        <a
                          ...
                          onClick={(ev) => {
                            ev.preventDefault();
                            const identifier = ev.target.closest("form").querySelector('input[name="identifier"]').value;
              ...
              {loading && (
                <div className="px-4 pb-4">
                  <div className="text-center small text-muted">Processing...</div>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content overflow-hidden p-0">
              ...
              <div className="modal-body text-center p-4">
                ...
                {isAdmin && (
                  <button className="btn btn-warning w-100 mt-3 fw-bold" onClick={() => setModalMode("adminPanel")}>
                    <i className="fas fa-tools me-2"></i>Open Admin Panel
                  </button>
                )}
            ...
            <div className="modal-content text-center p-5 border-0">
              <div className="modal-body">
                ...
                <p className="text-muted mt-3">
                  To install this app:
                  <br />
                  1. Click browser menu (⋮ or Share icon)
                  <br />
                  2. Select <b>"Add to Home Screen"</b> or <b>"Install App"</b>
                </p>
                <button className="btn btn-light rounded-pill px-4 mt-3" onClick={() => setModalMode(null)}>
                  Close
                </button>
              </div>
            </div>
                ...
                <form onSubmit={handlePaymentSubmit}>
                  ...
                  <div className="row">
                    <div className="col-6 mb-3">
                      <label className="form-label">TrxID</label>
                      <input type="text" name="TrxID" className="form-control" required />
                    </div>
                    <div className="col-6 mb-3">
                      <label className="form-label">Plan</label>
                      <select name="Package" className="form-select">
            ...
            <div className="modal-content border-0 shadow-lg" style={{ borderRadius: "20px", overflow: "hidden" }}>
              <div className="modal-body p-5 text-center">
                ...
                <p className="text-muted mb-4" style={{ fontSize: "15px", lineHeight: "1.7" }}>
                  This judgment is available for <b>Premium Members</b> only.
                  <br />
      ...
      {modalMode === 'gate' && (
        <div
          className="modal d-block notranslate"
            ...
            <div className="modal-content text-center p-5 border-0 shadow">
              <div className="modal-body">
                ...
                <p className="text-muted mt-3 mb-4">
                  Great news! The case is in our database.
                  <br />
                  However, <b>Advanced Search</b> is a <b>Premium Feature</b>.
                </p>
      ...
      <footer className="bg-dark text-secondary py-5 text-center notranslate">
        <div className="container">
      ...
      <a
        href="https://wa.me/8801911008518"
          ...
          <div className="modal-dialog modal-dialog-centered">
            ...
            >
              <div className="modal-body p-5 text-center">
                ...
                <div className="d-grid gap-2">
                  <button
                    className={`btn rounded-pill py-2 fw-bold ${
                      notice.type === 'error'
                        ? 'btn-danger'
                        : notice.type === 'warning'
                        ? 'btn-warning'
